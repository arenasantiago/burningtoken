...
export const LiveVoting: React.FC<LiveVotingProps> = ({
  ...
  return (
    <div className="bg-tribunal-card/90 backdrop-blur-xl border border-tribunal-border rounded-2xl p-6 sm:p-8 shadow-2xl space-y-8 max-w-4xl mx-auto relative overflow-hidden">
      ...
      {/* Claim Headline */}
      <div className="space-y-3 border-b border-slate-800/80 pb-5 relative z-10">
        <div className="flex flex-wrap items-center justify-between gap-2 text-xs font-mono">
          <span className="flex items-center space-x-2 text-purple-400">
            ...
            <span className="tracking-wider">CASO BAJO JURADO · PROPUESTO POR {authorName.toUpperCase()}</span>
          </span>
          <span className="flex items-center space-x-1.5 text-slate-300 bg-slate-800/60 px-2.5 py-1 rounded-full border border-slate-700/60">
        ...
        <blockquote className="text-xl sm:text-2xl font-extrabold text-white leading-snug border-l-4 border-purple-500 pl-4 py-2 italic bg-slate-950/60 rounded-r-xl tracking-tight">
          "{claimContent}"
        </blockquote>
      </div>
      ...
      {/* ========================================================= */}
      <div className="bg-slate-950/60 border border-slate-800/90 rounded-2xl p-6 relative overflow-hidden flex flex-col items-center">
      ...
      <div className="space-y-3">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          ...
          <button
            ...
            className={`p-5 rounded-2xl border flex items-center justify-between transition-all duration-300 transform active:scale-95 group relative overflow-hidden ${
              myVoteChoice === "SMOKE"
          ...
          >
            <div className="flex items-center space-x-3.5 text-left z-10">
              <div
              ...
              >
                <Flame className={`w-6 h-6 ${myVoteChoice === "SMOKE" ? "animate-pulse" : ""}`} />
              </div>
              <div>
                <div className="font-extrabold text-base flex items-center space-x-2">
                  <span>¡Es Puro Humo!</span>
                  {myVoteChoice === "SMOKE" && (
                    <span className="text-[10px] uppercase font-mono px-2 py-0.5 rounded bg-red-500/20 text-red-300 border border-red-500/40">
                      Tu Voto
                    </span>
                  )}
                </div>
                <div className="text-xs text-slate-400 mt-0.5">Promesa inflada / Sin sustento técnico</div>
              </div>
            </div>
          ...
          >
            <div className="flex items-center space-x-3.5 text-left z-10">
              ...
              >
                <CheckCircle2 className={`w-6 h-6 ${myVoteChoice === "LEGIT" ? "animate-pulse" : ""}`} />
              </div>
              <div>
                <div className="font-extrabold text-base flex items-center space-x-2">
                ...
                <div className="text-xs text-slate-400 mt-0.5">Técnicamente viable y fundamentado</div>
              </div>
            </div>
            <div className="text-right font-mono z-10">
      ...
      {/* ========================================================= */}
      <div className="bg-gradient-to-r from-purple-950/30 via-slate-950/50 to-indigo-950/30 border border-purple-900/40 rounded-xl p-3.5 flex flex-col sm:flex-row items-center justify-between gap-3">
        <div className="flex items-center space-x-2 text-xs font-mono text-purple-300">
          <Volume2 className="w-4 h-4 text-purple-400 animate-pulse" />
          <span className="font-semibold">Efectos Acústicos del Tribunal:</span>
          <span className="text-slate-400 text-[11px] hidden sm:inline">
            Diseño sonoro procedural sintetizado en tiempo real
          </span>
        </div>
        <div className="flex flex-wrap gap-2">
          <button
            ...
            className="px-2.5 py-1 rounded-lg bg-slate-900 hover:bg-purple-900/40 border border-slate-700/80 hover:border-purple-500/60 text-[11px] font-mono text-slate-300 flex items-center space-x-1 transition active:scale-95"
          >
          ...
          <button
            ...
            className="px-2.5 py-1 rounded-lg bg-slate-900 hover:bg-red-900/40 border border-slate-700/80 hover:border-red-500/60 text-[11px] font-mono text-slate-300 flex items-center space-x-1 transition active:scale-95"
          >
            <Flame className="w-3 h-3 text-red-400" />
            <span>Sirena</span>
          </button>
          <button
            ...
            className="px-2.5 py-1 rounded-lg bg-slate-900 hover:bg-amber-900/40 border border-slate-700/80 hover:border-amber-500/60 text-[11px] font-mono text-slate-300 flex items-center space-x-1 transition active:scale-95"
          >
      ...
      <div className="pt-4 border-t border-slate-800/80 flex flex-col sm:flex-row items-center justify-between gap-4">
        ...
        {isHost ? (
          <button
            ...
            className="w-full sm:w-auto bg-gradient-to-r from-purple-600 via-indigo-600 to-purple-600 hover:from-purple-500 hover:to-indigo-500 text-white font-extrabold px-7 py-3.5 rounded-xl flex items-center justify-center space-x-2.5 shadow-xl shadow-purple-600/30 transition-all transform hover:-translate-y-0.5 active:scale-95 group"
          >
            <Play className="w-4 h-4 fill-white group-hover:scale-110 transition-transform" />
            <span>Desplegar Auditoría Autónoma</span>
          </button>
        ) : (
          <div className="flex items-center space-x-2.5 bg-purple-950/40 border border-purple-800/60 text-purple-300 px-5 py-3 rounded-xl text-xs font-mono">
